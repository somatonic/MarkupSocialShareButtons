...
// http://customizr.net/icons/?set=social-media&preset=fff-100-50-4D5263-100-128-c-000-100#custom

$socialIcons = array(
    'email' => '<svg class="share-icon-email" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" style="height: 32px; width: 32px;">
                        <circle class="outer-shape" cx="50" cy="50" r="48" style="opacity: 1; fill: rgb(77, 82, 99);"></circle>
    ...
    'googleplus' => '<svg class="share-icon-googleplus" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" style="height: 32px; width: 32px;">
                        <circle class="outer-shape" cx="50" cy="50" r="48" style="opacity: 1; fill: rgb(77, 82, 99);"></circle>
    ...
    'facebook' => '<svg class="share-icon-facebook" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" style="height: 32px; width: 32px;">
                        <circle class="outer-shape" cx="50" cy="50" r="48" style="opacity: 1; fill: rgb(77, 82, 99);"></circle>
    ...
    'twitter' => '<svg class="share-icon-twitter" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" style="height: 32px; width: 32px;">
                        <circle class="outer-shape" cx="50" cy="50" r="48" style="opacity: 1; fill: rgb(77, 82, 99);"></circle>
    ...
    'linkedin' => '<svg class="share-icon-linkedin" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100" style="height: 32px; width: 32px;">
                        <circle class="outer-shape" cx="50" cy="50" r="48" style="opacity: 1; fill: rgb(77, 82, 99);"></circle>
